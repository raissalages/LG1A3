...
public class LivroDao  extends GenericDao {
	...
	public List<Livro> retornarLivroPorId(int id){
		...
		try {
			...
			livros = null; // Caso ocorra qualquer exce��o.
		}
		return livros; // Retorna o ArrayList de objetos Cargo.
	}
	...
	public static void main(String[] args) {
		...
		livroo.setTitulo("a");
		livroo.setAtivo(false);


		LivroDao ld = new LivroDao();

		Livro livrinho = new Livro();
		livrinho.setTitulo("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
		livrinho.setAtivo(false);
